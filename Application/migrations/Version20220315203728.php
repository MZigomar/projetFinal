 ...
 */
final class Version20220315203728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP description, DROP image, DROP stock, DROP slug');
    }
